...
class TestKnxTelegram: XCTestCase {
    ...
    func testDPT5_001() {
        ...
        bytes[8] = 128
        XCTAssertEqual(try KnxTelegram(bytes: bytes).getValueAsType(type:.dpt5_001), 50 )
    ...
    func testDPT10_001() {
        ...
        bytes[9] = 0x00
        bytes[10] = 0x00
        XCTAssertEqual(try KnxTelegram(bytes: bytes).getValueAsType(type:.dpt10_001), "?? 00:00:00")
